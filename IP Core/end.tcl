...
set rc [catch {
  ...
  set_property webtalk.parent_dir {E:/AI/XilinxData/one more/one more.cache/wt} [current_project]
  set_property parent.project_path {E:/AI/XilinxData/one more/one more.xpr} [current_project]
  set_property ip_repo_paths {{E:/AI/one more try}} [current_project]
  update_ip_catalog
  set_property ip_output_repo {{E:/AI/XilinxData/one more/one more.cache/ip}} [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
  add_files -quiet {{E:/AI/XilinxData/one more/one more.runs/synth_1/design_1_wrapper.dcp}}
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files {{E:/AI/XilinxData/one more/one more.srcs/sources_1/bd/design_1/design_1.bd}}
